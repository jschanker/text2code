...
(function(namespace) {
    ...
    var blockGeneratorArgs = {
        ...
        expressionIntDivide     : [bg.generateMathArithmeticIntDivide, [1, 3]],
        ...
        expressionTextLength    : [bg.generateTextLength, [2]], 
        ...
        statementMultiplyVar    : [bg.generateVariablesMultiply, [2, 4]],
        statementDivideVar      : [bg.generateVariablesDivide, [2, 4]],
        statementAddToVar       : [bg.generateVariablesIncrease, [4, 2]],
        statementMinusFromVar   : [bg.generateVariablesDecrease, [4, 2]],
